...
pupil_vals.surfaceName = NaN(1,'single');
...
%         fprintf('Gaze Received\n')
        fprintf('Eye tracking data: [%.2f, %.2f], %.2f, %.2f\n',pupil_vals.gazePosition(1),...
    ...
    case 1
        ...
        pupil_vals.surfaceName = char(typecast(pkt(22:end-1),'single'));
        fprintf('Surface Received\n')
        fprintf('Eye tracking data: [%.2f, %.2f], %.2f, %.2f, %.2f, %s\n',pupil_vals.gazePosition(1),...
            pupil_vals.gazePosition(2),pupil_vals.gazeConfidence, pupil_vals.gazeTime, ...
            pupil_vals.gazeOnSurface, pupil_vals.surfaceName)
    case 3
        % default value: all NaNs
        fprintf('Eye tracking data: [%.2f, %.2f], %.2f, %.2f, %.2f, %.7f\n',pupil_vals.gazePosition(1),...
            pupil_vals.gazePosition(2),pupil_vals.gazeConfidence, pupil_vals.gazeTime, ...
            pupil_vals.gazeOnSurface, pupil_vals.surfaceName)
    otherwise
